...
/**
 * Fragment that displays the Tenant information.
 */
public class CardInfoTenantFragment extends Fragment {
    ...
    /**
     * Method that creates a intent to call CardInfoTenantFragment.
     *
     * @param profile Profile that is used to create a bundle for the intent.
     * @return Intent to start the CardInfoTenantFragment class with the corresponding Bundle.
     */
    ...
    /**
     * updates the fields of the fragment with the values find on mProfile.
     */
