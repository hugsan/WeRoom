...
/**
 * Card information fragment that display information of a a room and its corresponding landlord.
 */
public class CardInfoRoomFragment extends Fragment {
    ...
    /**
     * Method to create a intent to call the CardInfoRoomFragment.
     *
     * @param room RoomPosted that need to be displayed in CardInfoRoomFragment.
     * @return Intent with the corresponding bundle.
     */
    ...
    /**
     * Updates the fields with the values of the fragment with mRoomPosted and its corresponding
     * landlord.
     */
