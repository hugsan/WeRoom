...
public class Profile implements Serializable, Parcelable {
    ...
    /**
     * We consider to Profile identical if they have the same ID.
     *
     * @param o Profile to be compared.
     * @return True if both object are instance of Profile and contain the same userID, otherwise false.
     */
    @Override
