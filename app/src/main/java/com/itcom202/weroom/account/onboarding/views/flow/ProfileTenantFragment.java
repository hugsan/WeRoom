...
/**
 * Fragment that allows the user to create a TenantProfile.
 */
public class ProfileTenantFragment extends Fragment {
    ...
    public View onCreateView( @NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState ) {
        View v = inflater.inflate( R.layout.tenant_profile_fragment, container, false );
        ...
        ArrayAdapter adapterPeriodRent = ArrayAdapter.createFromResource( Objects.requireNonNull( getActivity( ) ), R.array.rending_period_array, R.layout.spinner_item );
        ...
        // Initialize Places and using the API key to get validated by Google.
